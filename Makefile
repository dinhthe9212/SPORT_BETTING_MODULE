...
migrate:
	...
	docker-compose exec carousel_service python manage.py migrate
	docker-compose exec individual_bookmaker_service python manage.py migrate
	docker-compose exec risk_management_service python manage.py migrate
	docker-compose exec saga_orchestrator python manage.py migrate
	docker-compose exec sports_data_service python manage.py migrate
